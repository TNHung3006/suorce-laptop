...
int main(){
    ...
    //tach mang toan snt.
    TachSnt(a, b, na, nb);
    cout << "\nmang b toan snt sau khi tach mang a la: ";
    Xuatmang(b, nb);

    //tách 1 mảng thành 2 mảng, mảng a chứa số dương và b chứa số còn lại
    TachSoDuong(a, b, c, na, nb, nc);
    cout << "\nmang b toan so duong sau khi tach mang a la: ";
    Xuatmang(b, nb);
    cout << "\nmang c chua cac so con lai cua mang a la: ";
    Xuatmang(c, nc);
